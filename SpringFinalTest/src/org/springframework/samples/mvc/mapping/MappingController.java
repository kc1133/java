...
public class MappingController {
	...
	public @ResponseBody String byProducesJson() {
		return new JavaBean().toString();
	}

	@RequestMapping(value="/mapping/produces2", method=RequestMethod.GET, produces=MediaType.APPLICATION_XML_VALUE)
